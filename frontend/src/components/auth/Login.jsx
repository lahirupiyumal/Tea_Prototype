    ...
    <main className="relative flex min-h-screen overflow-hidden bg-[#f5faf3] font-['Inter',sans-serif] text-[#153c31]">
      ...
      <section className="relative flex min-h-screen w-full items-center justify-center px-5 py-12 sm:px-8">
        <div className="w-full max-w-md">
          <a href="/home" className="mb-12 flex items-center justify-center text-lg font-bold tracking-[.16em]"><img className="mr-2 h-9 w-9 object-contain" src="/teawise-logo.png" alt="TeaCore logo" />Tea<span className="text-[#568f32]">Core</span></a>
