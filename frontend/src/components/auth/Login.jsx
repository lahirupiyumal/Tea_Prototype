    ...
    <main className="relative flex min-h-screen overflow-hidden bg-[#f5faf3] font-['Inter',sans-serif] text-[#153c31]">
      ...
      <section className="relative flex min-h-screen w-full items-center justify-center px-5 py-12 sm:px-8">
        <div className="w-full max-w-md">
          <a href="/home" className="mb-12 flex items-center justify-center text-lg font-bold tracking-[.16em]"><img className="mr-2 h-9 w-9 object-contain" src="/teawise-logo.png" alt="TeaNex AI logo" />Tea<span className="text-[#568f32]">Nex AI</span></a>
          <div className="rounded-[1.75rem] border border-[#dce9df] bg-white p-7 shadow-[0_24px_70px_rgba(21,60,49,.08)] sm:p-10">
            <div className="mb-8"><h2 className="font-['Space_Grotesk',sans-serif] text-3xl font-semibold">Sign in</h2><p className="mt-2 text-sm text-[#6a7f76]">Choose your role and continue to TeaNex AI.</p></div>
            ...
            <div className="mt-8 flex items-center justify-center gap-2 border-t border-[#edf1ed] pt-6 text-xs text-[#789087]"><ShieldCheck size={15} className="text-[#568f32]" /> Your data is protected by TeaNex AI security</div>
          </div>
