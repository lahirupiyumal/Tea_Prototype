      ...
      <div className="component4-layout">
        ...
        <main className="component4-main">
          <header className="component4-topbar">
            <div className="topbar-search"><Search size={16} /><input aria-label="Search TeaNex AI" placeholder="Search your tea intelligence" /><kbd>⌘ K</kbd></div>
...
function BrandMark() {
  return <a className="component4-brand" href="/home"><div className="tea-logo"><img src="/teawise-logo.png" alt="TeaNex AI logo" /></div><div><h2>Tea<b>Nex AI</b></h2><span>Intelligence rooted in tea</span></div></a>;
}
