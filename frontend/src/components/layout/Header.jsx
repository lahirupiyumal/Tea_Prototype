    ...
    <header className="sticky top-0 z-50 border-b border-[#e7eee8] bg-white/95 shadow-[0_4px_18px_rgba(23,61,46,.06)] backdrop-blur">
      <nav className="mx-auto flex min-h-[76px] max-w-7xl items-center justify-between gap-6 px-5 md:px-8" aria-label="Main navigation">
        ...
        <div className="flex shrink-0 items-center gap-2">
          <a className="hidden rounded-full px-3 py-2.5 text-[13px] font-semibold text-[#315444] transition hover:bg-[#f1f7ef] sm:block" href="/login">Login</a>
          <a className="hidden rounded-full bg-[#82c54d] px-4 py-2.5 text-[13px] font-bold text-[#173d2e] shadow-[0_8px_18px_rgba(86,143,50,.18)] transition hover:-translate-y-0.5 md:block" href="/harvest-intelligent">Harvest AI</a>
          <a className="rounded-full bg-[#173d2e] px-4 py-2.5 text-[13px] font-bold text-white shadow-[0_8px_18px_rgba(23,61,46,.16)] transition hover:-translate-y-0.5 hover:bg-[#245641]" href="/dashboard">Dashboard</a>
